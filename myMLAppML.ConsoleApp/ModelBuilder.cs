...
namespace MyMLAppML.ConsoleApp
{
    ...
    {
        private static string TRAIN_DATA_FILEPATH = @"D:\Dev\Machine_Learning\ML.NET\myMLApp\wikipedia-detox-250-line-data.tsv";
        private static string MODEL_FILEPATH = @"C:\Users\fpaul\AppData\Local\Temp\MLVSTools\myMLAppML\myMLAppML.Model\MLModel.zip";
